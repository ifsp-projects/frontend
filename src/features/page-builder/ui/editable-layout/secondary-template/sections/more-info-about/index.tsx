...
import { EditableImageField } from '@/features/page-builder/components/template-fields/editable-image-field'

import type { MoreInfoAboutProps } from './types'

export const MoreInfoAbout: React.FC<MoreInfoAboutProps> = ({ copy }) => {
  return (
