export const USE_CASES = [
  ...
  },
  {
    ...
    prompt:
      'Escreva uma descrição institucional da nossa ONG focada em atrair parceiros corporativos. Profissional e com dados de impacto.',
    output:
      'O Instituto Raízes atua desde 2010 em comunidades vulneráveis de São Paulo, com metodologia comprovada e impacto mensurável: mais de 6.000 famílias atendidas, 94% de aprovação e auditoria contábil anual independente. Buscamos parceiros que acreditam que responsabilidade social vai além do relatório de ESG...'
  }
] as const
