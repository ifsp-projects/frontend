...
import { Details as PrimaryTemplateDetails } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/primary/sections/details'
import { Header as PrimaryTemplateHeader } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/primary/sections/header'
import { Mission as PrimaryTemplateMission } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/primary/sections/mission'
import { Causes as QuarternaryTemplateCauses } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/quarternary/sections/causes'
import { GetInvolved as QuarternaryTemplateGetInvolved } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/quarternary/sections/get-involved'
import { Header as QuarternaryTemplateHeader } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/quarternary/sections/header'
import { Timeline as QuarternaryTemplateTimeline } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/quarternary/sections/timeline'
import { AboutUs as SecondaryTemplateAboutUs } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/secondary/sections/about-us'
import { Header as SecondaryTemplateHeader } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/secondary/sections/header'
import { HowItWorks as SecondaryTemplateHowItWorks } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/secondary/sections/how-it-works'
import { MoreInfoAbout as SecondaryTemplateMoreInfoAbout } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/secondary/sections/more-info-about'
import { AboutUs as TertiaryTemplateAboutUs } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/tertiary/sections/about-us'
import { Header as TertiaryTemplateHeader } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/tertiary/sections/header'
import { HowItWorks as TertiaryTemplateHowItWorks } from '@/app/(user-scope)/ongs/[slug]/readable-layout/templates/tertiary/sections/how-it-works'
