...
export class Organizations {
   ...
   * @returns {Promise<CreateOrganizationResponse | { status: string, data: { organization: OrganizationProps } }>}
  ...
  createOrganization = async ({ payload, token }: CreateOrganizationData) => {
    try {
      ...
      return {
        ...
        data: { organization: {} as OrganizationProps }
      }
    }
  }
   ...
   * * @async
   * @returns {Promise<GetAllOrganizationsResponse | { status: string, data: { organizations: OrganizationProps[] } }>}
  ...
  getAllOrganizations = async (params?: GetAllOrganizationsData) => {
    try {
      ...
      return {
        status: error.message,
        data: { organizations: {} as OrganizationProps[] }
      }
    }
  }
   ...
   * @returns {Promise<GetOrganizationByIdResponse | { status: string, data: { organization: OrganizationProps } }>}
   ...
   * @returns {Promise<GetOrganizationBySlugResponse | { status: string, data: { organization: OrganizationProps } }>}
   * A promise that resolves to the organization data, or a fallback object on failure.
   */
   ...
   * @param {string} params.token - The authorization bearer token.
   * @returns {Promise<UpdateOrganizationResponse | { status: string, data: { organization: OrganizationProps } }>}
   ...
   * @param {string} params.token - The authorization bearer token.
   * @returns {Promise<DeleteOrganizationResponse | { status: string, data: { organization: OrganizationProps } }>}
