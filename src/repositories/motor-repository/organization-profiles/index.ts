...
export class OrganizationProfiles {
   ...
   * @returns {Promise<CreateOrganizationProfileResponse | { status: number, data: { organizationProfile: OrganizationProfileProps } }>}
  ...
  createOrganizationProfile = async ({
    ...
    try {
      ...
      return {
        status: error.status,
        data: { organizationProfile: {} as OrganizationProfileProps }
      }
    }
  }
   ...
   * @param {string} params.token - The authorization bearer token.
   * @returns {Promise<UpdateOrganizationProfileResponse | { status: number, data: { organizationProfile: OrganizationProfileProps } }>}
