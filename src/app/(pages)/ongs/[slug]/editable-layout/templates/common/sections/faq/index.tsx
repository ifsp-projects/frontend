    ...
    <section className="px-4 py-12 lg:py-16 xl:px-0">
      <div className="mx-auto flex w-full max-w-2xl flex-col lg:max-w-7xl lg:flex-row lg:justify-between">
        <article className="flex w-full flex-col gap-6">
          ...
          <EditableCopyField
            as="div"
            className={`mt-2 mb-7 flex max-w-fit items-center justify-center rounded-md border px-6 py-2 text-center text-sm transition-all duration-300 lg:mb-0 hover:brightness-105 text-${color}-500 border-${color}-500`}
