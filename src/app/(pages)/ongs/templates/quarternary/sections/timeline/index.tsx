      ...
      <div className="mx-auto w-full max-w-2xl lg:max-w-7xl">
        <div className="mb-16 flex flex-col gap-3">
          ...
          <h2 className="max-w-lg text-3xl leading-tight font-black text-neutral-800 lg:text-4xl">
            14 anos construídos{' '}
            <span className="text-rose-600">um passo de cada vez.</span>
          </h2>
        </div>
        ...
        <div className="mt-20 flex flex-col items-center gap-4 border-t border-neutral-200 pt-12 text-center">
          ...
          <Link
            className="rounded-none bg-rose-600 px-8 py-3.5 text-sm font-black tracking-wider text-white uppercase shadow-lg shadow-rose-200 transition-all duration-300 hover:bg-rose-700"
            href="#"
          >
