  ...
  return (
    <section className="w-full bg-white px-4 pt-8 pb-12 lg:py-16 xl:px-0">
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-4 lg:max-w-7xl">
        ...
        <Link
          className="mt-2 flex cursor-pointer items-center gap-3 rounded-full bg-neutral-700 py-2.5 pr-4 pl-5 text-sm font-semibold text-white transition-all duration-150"
          href="/contato"
        >
          Enviar sugestão
