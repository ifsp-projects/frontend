...
- [Cadastro de Apoiador](https://capivara-solidaria.com.br/cadastro): Criação de conta gratuita para apoiadores acompanharem ONGs favoritas.
- [Cadastro de ONG](https://capivara-solidaria.com.br/cadastro-ong): Processo de verificação e onboarding para organizações sem fins lucrativos.
...
- Conformidade com a LGPD (Lei 13.709/2018) e Marco Civil da Internet (Lei 12.965/2014)
- Contato: contato@capivara-solidaria.com.br

## Sobre

Fundada em 2024, a Capivara Solidária nasceu da necessidade de centralizar e tornar mais acessível a descoberta de ONGs confiáveis no Brasil. Todas as organizações listadas passam por um processo de curadoria e verificação documental antes de aparecerem na plataforma.
