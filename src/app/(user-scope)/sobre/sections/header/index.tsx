    ...
    <section className="px-4 py-12 lg:py-16 xl:px-2">
      <header className="mx-auto flex w-full max-w-2xl flex-col gap-8 lg:max-w-7xl lg:gap-12">
        ...
        <div className="mx-auto flex h-auto max-w-2xl flex-col items-stretch gap-4 lg:max-w-5xl lg:flex-row lg:gap-6">
          <figure className="group hidden aspect-square h-auto w-full overflow-hidden rounded-sm lg:block">
            <Image
              alt="Header Image"
          ...
          <figure className="group block aspect-video h-full max-h-[490px] w-full overflow-hidden rounded-sm lg:hidden">
            <Image
              alt="Header Image"
          ...
          <div className="hidden h-auto flex-col gap-4 lg:flex lg:gap-6">
            <figure className="group hidden aspect-video h-full max-h-[490px] w-full overflow-hidden rounded-sm lg:block">
              <Image
                alt="Header Image"
                className="aspect-video h-full w-full scale-[1.01] rounded-sm object-cover transition-all duration-300 group-hover:scale-100"
                fetchPriority="high"
